...
public class ThemeManager {
    ...
    public void setTheme(Activity context, String theme){
        String curTheme = OSCSharedPreference.getInstance().getCurrentTheme();
        if(curTheme != null && curTheme.equals(theme)){
            return;
        }

        OSCSharedPreference.getInstance().putCurrentTheme(theme);
        context.finish();
    ...
    public String getCurThemeName(Context context){
        return OSCSharedPreference.getInstance().getCurrentTheme();
    }

    public void init(Context context) {
        String theme = OSCSharedPreference.getInstance().getCurrentTheme();
