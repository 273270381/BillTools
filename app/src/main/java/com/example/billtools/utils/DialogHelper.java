...
public final class DialogHelper {
     ...
     * 获取一个选择对话框
     */
    public static MaterialDialog.Builder getChoiceDialog(Context context,String title, String[] strs,
                                                         MaterialDialog.ListCallbackSingleChoice callbackSingleChoice){
        return getChoiceDialog(context, title, strs, "确定", "取消",callbackSingleChoice);
    }

    /**
     *获取电话输入对话框
     */
    public static MaterialDialog.Builder getPhoneNumberDialog(
            Context context,
            String title,
            int inputType,
            String hint,
        ...
        return new MaterialDialog.Builder(context)
                ...
                .input(hint,msg,inputCallback)
                .positiveText("确定");
    }

    public static MaterialDialog.Builder getChoiceDialog(
            Context context,
            String title,
            String[] str,
            String positiveText,
        ...
        return new MaterialDialog.Builder(context)
                ...
                .itemsCallbackSingleChoice(0, callbackSingleChoice);
    }
