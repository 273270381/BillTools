package com.example.billtools.ui.adapter;
...
import com.example.billtools.utils.ImageUtils;
import com.example.billtools.widget.SwipeMenuView;
import com.example.billtools.widget.stickyheader.StickyHeaderGridAdapter;

import java.util.List;

import static com.example.billtools.utils.DateUtils.FORMAT_HMS_CN;
import static com.example.billtools.utils.DateUtils.FORMAT_YMD_CN;
...
public class MonthListAdapter extends StickyHeaderGridAdapter {
    ...
    public void onBindItemViewHolder(ItemViewHolder viewHolder, final int section, final int position) {
        ...
        CoBill bBill = mDatas.get(section).getList().get(position);
    ...
    public interface OnStickyHeaderClickListener {
        void OnDeleteClick(CoBill item, int section, int offset);

        void OnEditClick(CoBill item, int section, int offset);
    }
