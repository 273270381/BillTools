package com.example.billtools.ui.adapter.binder;
 ...
 */
public class MonthChartBillViewBinder extends ItemViewBinder<CoBill, MonthChartBillViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull CoBill item) {
