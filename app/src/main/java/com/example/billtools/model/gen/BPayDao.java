...
public class BPayDao extends AbstractDao<BPay, Long> {
    ...
    public static class Properties {
        ...
        public final static Property InCome = new Property(3, Float.class, "inCome", false, "IN_COME");
        public final static Property OutCome = new Property(4, Float.class, "outCome", false, "OUT_COME");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BPAY\" (" + //
                ...
                "\"IN_COME\" REAL," + // 3: inCome
                "\"OUT_COME\" REAL);"); // 4: outCome
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, BPay entity) {
        ...
        Float inCome = entity.getInCome();
        if (inCome != null) {
            stmt.bindDouble(4, inCome);
        }
 
        Float outCome = entity.getOutCome();
        if (outCome != null) {
            stmt.bindDouble(5, outCome);
        }
    }
    ...
    public BPay readEntity(Cursor cursor, int offset) {
        BPay entity = new BPay( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getFloat(offset + 3), // inCome
            cursor.isNull(offset + 4) ? null : cursor.getFloat(offset + 4) // outCome
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, BPay entity, int offset) {
        ...
        entity.setInCome(cursor.isNull(offset + 3) ? null : cursor.getFloat(offset + 3));
        entity.setOutCome(cursor.isNull(offset + 4) ? null : cursor.getFloat(offset + 4));
     }
