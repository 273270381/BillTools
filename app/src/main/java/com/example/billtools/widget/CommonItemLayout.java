package com.example.billtools.widget;
...
import com.example.billtools.utils.DimenUtils;
import com.example.billtools.utils.UiUtils;
...
public class CommonItemLayout extends FrameLayout {
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.view_common_layout, this, true);
